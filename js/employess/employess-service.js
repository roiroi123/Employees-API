...
var employess_repository_1 = require("./employess-repository");
var employess_repository_2 = require("./employess-repository");
var EmployeeService = /** @class */ (function () {
    function EmployeeService() {
    }
    EmployeeService.prototype.all = function () {
        return __awaiter(this, void 0, void 0, function () {
            var Employess;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, employess_repository_2.default.getAll()];
                    case 1:
                        Employess = _a.sent();
                        //להחזיר רשימת מוצרים;
    ...
    EmployeeService.prototype.AddOne = function (employee) {
        return __awaiter(this, void 0, void 0, function () {
            var employees;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, employess_repository_1.default.SaveAll(employees)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, employee];
                }
